...
list = guahaoDao.select4List(user);
%>
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="">个人挂号管理</a>
		</div>
			...
			<ul class="nav" id="main-menu">
				<li>
					<div class="user-img-div">
						<div class="inner-text">
							<%=dd.getRealname() %> <br /> <small id = "now"></small>
						</div>
					</div>
				...
				<li><a href="#" class="active-menu-top"><i
					...
					<ul class="nav nav-second-level collapse in">
						<li><a href="guahao.jsp"><i
								class="fa fa-coffee"></i>挂号管理</a></li>
						<li><a class="active-menu" href="guahao_persion.jsp"><i
							...
							<tbody>
								<%
									for (Guahao guahao : list) {
										department = departmentDao.select(guahao.getDepartmentId());
										int state = guahao.getState();
								...
								<tr class="list-group-item-success">
									...
									<td><%=guahao.getDoctorName()%></td>
									<td><%=guahao.getTime()%></td>
									<td><%=stateStr%></td>
								</tr>
								<%
									}
