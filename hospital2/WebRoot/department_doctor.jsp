...
<body>
	<div id="wrapper">
			...
			<ul class="nav" id="main-menu">
				...
				<li><a href="#" class="active-menu-top"><i class="fa fa-desktop "></i>科室管理<span
					...
					<ul class="nav nav-second-level collapse in">
						...
						<li><a class="active-menu" href="department_doctor.jsp?currentPage=1"><i
		...
		if(idStr != null){
			...
			list = doctorDao.select4List(doctor);
		%> 
		</nav>
		<!-- /. NAV SIDE  -->
		<div id="page-wrapper">
	...
	<%}else{
		...
		list2 = (List<Department>) map.get("data");
						...
						<table class="table">
							...
							<tbody>
								...
								<tr class="list-group-item-success">
									...
									<td><%=d.getIntroduce()%></td>
									<td>
										<form action="department_doctor.jsp" method = "post">
										<input type = "hidden" value = "<%=d.getId()%>" name = "did" id = "did">
										<button class="btn btn-primary" type = "submit">
											<i class="glyphicon glyphicon-search"></i>查看医生
										</button>
										</form>
									</td>
								</tr>
