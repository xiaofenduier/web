			...
			<ul class="nav" id="main-menu">
				...
				<li><a href="#" class="active-menu-top"><i
					...
					<ul class="nav nav-second-level collapse in">
						...
						<li><a class="active-menu" href="root_addroot.jsp"><i class="fa fa-send "></i>增加管理员信息</a>
						</li>
					</ul></li>
			</ul>
					...
					<div class="col-md-12">
						<div class="panel-heading">
							...
							<div class="modal-dialog">
								<form role="form" action="userDao.jsp?op=addroot" method="post">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal"
												aria-hidden="true">×</button>
											<h4 class="modal-title" id="myModalLabel">增加管理员信息</h4>
										</div>
										<div class="modal-body">
											<div class="form-group">
												<label>管理员姓名</label> <input id="realname" name="realname"
											...
											<div class="form-group">
												<label>身份证</label> <input id=""passport"" name="passport"
													class="form-control" type="text" >
											</div>
											<div class="form-group">
												<label>管理员性别</label> <select class="form-control" id="sex"
													name="sex">
											...
											<div class="form-group">
												<label>管理员年龄</label> <input id="age" name="age"
													class="form-control" type="text">
											</div>
											<div class="form-group">
